...
*******************************************************************************/
#define SIM_TIME   800       // Simulation time
#define ARR_TIME   20        // Mean time between arrivals
#define SERV_TIME  0.5        // Mean service time
...
int main()
{
    ...
    int c = k;              // Number of servers in the system
    ...
    w = l / x;              // Avg Sojourn time
        ...
        if (l * 500 * 800 - 1000*k * 100 > ans_mon)
        {
            ans_k = k;
            ans_mon = l * 500 * 800 - 1000*k * 100;
        }
        printf("%d\n",ans_k);
        fprintf(fp, "%d     %lf     %lf\n",k,l * 500 * 800 - 1000*k * 100,l/k);
